...
const Review = () => {
  return (
    <div className="w-full  flex justify-center flex-col items-center gap-10">
        <h1 className="font-semibold w-[30rem] text-gray-500 text-3xl sm:text-2xl ">
          As a platform our job is keeping the user <span className="text-gray-900">comfort</span>, <span className="text-gray-900">comfortefficiency</span>, and <span className="text-gray-900">productivity</span> so they bring dreams comes alive.
        </h1>
      <div className="flex justify-center pb-10">
        
        {reviewCardData.map((data, index) => (
          <>
            <div key={index} className="w-80 p-6 border-2 flex justify-center items-start flex-col gap-4 ">
